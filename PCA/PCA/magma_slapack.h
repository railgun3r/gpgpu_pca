...
// ACD: defined above as blasf77_Xgemm()
//#define lapackf77_sgemm    FORTRAN_NAME( sgemm,  SGEMM  )
// :ACD
...
// ACD: trsm is defined above as a blasf77_ routine
//#define lapackf77_strsm    FORTRAN_NAME( strsm,  STRSM )
// :ACD
...
void     lapackf77_sgels(const char *trans, 
                         ...
                         float *work, magma_int_t *lwork, magma_int_t *info);
// ACD:  LAPACK routines declared here (std Netlib declarations) and linked in with MKL math lib
/*  defined above as blasf77_Xgemm()
void	lapackf77_sgemm(const char* transA,
						const char* transB,
						magma_int_t *m,
						magma_int_t *n,
						magma_int_t *k,
