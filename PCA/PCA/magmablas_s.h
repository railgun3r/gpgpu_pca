...
//	
//// ACD 2013-09-17 custom OpenCL code replacement for broken clAmdBlasStrsmEx()
//// magma_atrsm_custom() is defined in interface_opencl/strsm_gpu.cpp and .cl.
//magma_err_t
//magma_strsm_custom(
//    magma_side_t side, magma_uplo_t uplo, magma_trans_t trans, magma_diag_t diag,
//	int m, int n,
//	float alpha,
//	cl_mem A, int Aoffset, int lda, 
//	cl_mem B, int Boffset, int ldb,
//	magma_queue_t queue );
