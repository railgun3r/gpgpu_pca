...
#define HAVE_clAmdBlas
    ...
    #define MAGMA_Z_SET2REAL(a,r) { (a).s[0] = (r);   (a).s[1] = 0.0; }
    ...
    #define MAGMA_C_SET2REAL(a,r) { (a).s[0] = (r);   (a).s[1] = 0.0; }
...
// ACD
//	#define MAGMA_Z_DSCALE(v, t, s)   {(v).s[0] = (t).s[0]/(s); (v).s[1] = (t).s[1]/(s);}
	#define MAGMA_Z_DSCALE(v, t, scale)   {(v).s[0] = (t).s[0]/(scale); (v).s[1] = (t).s[1]/(scale);}
...
// ACD
//	#define MAGMA_C_SSCALE(v, t, s)   {(v).s[0] = (t).s[0]/(s); (v).s[1] = (t).s[1]/(s);}
	#define MAGMA_C_SSCALE(v, t, scale)   {(v).s[0] = (t).s[0]/(scale); (v).s[1] = (t).s[1]/(scale);}
...
#define MAGMA_Z_NEGATE(a)         MAGMA_Z_MAKE(-(a).s[0], -(a).s[1])
...
#define MAGMA_C_NEGATE(a)         MAGMA_C_MAKE(-(a).s[0], -(a).s[1])
