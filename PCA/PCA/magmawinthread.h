...
//ACD adding def of __midl per http://msdn.microsoft.com/en-us/library/windows/desktop/aa367301%28v=vs.85%29.aspx
#define __midl 600
// ACD adding def of __int3264
#define __int3264 int
// ACD SSE2 is default option (without command arg /arch:SSE2) in VS2008 is to provide support for SSE2
// but just defining it here doesn't seem to work (yet)
//#define __SSE2__
// ACD
