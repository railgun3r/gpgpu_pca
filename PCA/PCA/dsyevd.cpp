...
//#define ENABLE_TIMER
	...
	//lapackf77_dsytrd(_uplo_, &n, a, &lda, w, &work[inde],
    ...
    if (! wantz) {
		...
		lapackf77_dstevd(V_char, &n, w, &work[inde],
			&work[indwrk], &n, &work[indwk2],
        ...
        start = get_current_time();
#endif
		lapackf77_dormtr(L_char, lapack_const(uplo), N_char, &n, &n, a, &lda, &work[indtau],
